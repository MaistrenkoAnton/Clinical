...
class BriefSummaries(models.Model):
    nct = models.ForeignKey('Studies', models.DO_NOTHING, unique=True, blank=True, null=True)
    description = models.TextField(blank=True, null=True)
...
class Studies(models.Model):
    nct_id = models.CharField(unique=True, max_length=255, blank=True, null=True)
